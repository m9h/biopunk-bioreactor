...
| [`docs/oxidant-morbidostat.md`](docs/oxidant-morbidostat.md) | A **devo** experiment proposal: run the evolution machine as an H₂O₂-morbidostat to test whether chemical bloom-control selects for resistant cyanobacteria — three stacked novelty claims (H₂O₂-resistance evolution untested; no automated phototroph ALE; no automated phototroph fossil record). **The experiment.** |
