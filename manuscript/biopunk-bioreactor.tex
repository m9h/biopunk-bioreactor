...
This working paper has four aims. Section~\ref{sec:purposes} sets out the three purposes.
...
\textbf{Purpose 1 --- Characterisation.} Hold a culture in a defined, unchanging state and
...
\textbf{Purpose 2 --- Evolution.} Push a culture through selection regimes unattended for
...
\textbf{Purpose 3 --- Scale-out operation.} Run many reliable reactors now, with minimal build
...
P1~(characterise), P2~(evolve), P3~(scale-out). Cells reflect each platform as published or
...
\midrule
Primary purpose & P1 & P2 & P3 & P3 & P2 \\
...
belongs to purpose P2: it is the canonical antibiotic-resistance device (working volume
...
the only pure Purpose-3 product; its credibility is commercial and community rather than
