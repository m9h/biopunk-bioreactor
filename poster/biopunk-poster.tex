...
\vspace{6pt}
\centering
{\qrset{height=5cm}\qrcode[level=M]{https://github.com/m9h/biopunk-bioreactor}}\\[6pt]
\Large\ac{github.com/m9h/biopunk-bioreactor}\\[3pt]
\normalsize scan for the paper, slides, data \& all docs $\cdot$ public $\cdot$ CC BY 4.0
}
